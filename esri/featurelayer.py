'''Create code re-use library for ArcGIS stuff
    ...
    check out the pdb module for setting break points in python
...
class ArcMapFeatureLayer(object):
    '''

    Q.  How to handle license level instatiation and handle software package target?
    A.  ??

    Q.  Maybe testing whether the data source is an sde or gdb store will be enough of an
...
##            arcpy.AddField_management(self.path, fieldname, fieldtype, "", "")
    ...
    def cursor_to_dicts(self, generator=None):
        '''
